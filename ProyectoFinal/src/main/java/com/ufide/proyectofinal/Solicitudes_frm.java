...
public class Solicitudes_frm extends javax.swing.JDialog {
    ...
    public void llenar_cajas(){
        ...
        this.txtFecha.setText(TabDatos.getValueAt(TabDatos.getSelectedRow(), 3).toString());
        this.txtNombre.setText(TabDatos.getValueAt(TabDatos.getSelectedRow(), 4).toString());
        this.txtCantidadDias.setText(TabDatos.getValueAt(TabDatos.getSelectedRow(), 5).toString());
        this.cbxCategoria.setSelectedItem(TabDatos.getValueAt(TabDatos.getSelectedRow(), 6).toString());
        this.txtMarca.setText(TabDatos.getValueAt(TabDatos.getSelectedRow(), 7).toString());
        this.txtPrecioAlquiler.setText(TabDatos.getValueAt(TabDatos.getSelectedRow(), 8).toString());
        this.cbxEstadoSolicitud.setSelectedItem(TabDatos.getValueAt(TabDatos.getSelectedRow(), 9).toString());
    ...
    public void limpiar_cajas() {
        ...
        this.cbxEstadoSolicitud.setSelectedIndex(0);
        this.cbxArranqueSinLLave.setSelected(false);
        this.cbxCargadorInalambrico.setSelected(false);
        this.cbxNavegadorTraffico.setSelected(false);
        this.cbxSensores.setSelected(false);
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        ...
        if(encontrar==null){
            ...
            encontrar.setAnnio(Integer.parseInt(txtFecha.getText()));
            encontrar.setColor(txtNombre.getText());
            encontrar.setCilindrada(txtCantidadDias.getText());
            encontrar.setTipoCombustible(cbxCategoria.getSelectedItem().toString());
            encontrar.setCapacidadPasajeros(Integer.parseInt(txtMarca.getText()));
            encontrar.setPrecioAlquierXDia(Double.parseDouble(txtPrecioAlquiler.getText()));
            encontrar.setEstado(cbxEstadoSolicitud.getSelectedItem().toString());
    ...
    private void btnGuardActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardActionPerformed
        ...
        if (txtNumeroSolicitud.getText().isEmpty() == false
            ...
            || txtFecha.getText().isEmpty() == false
            || txtNombre.getText().isEmpty() == false
            || txtCantidadDias.getText().isEmpty() == false
            || txtMarca.getText().isEmpty() == false
